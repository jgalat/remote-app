export const TORRENT_ACTIONS_SHEET_ID = "torrent-actions" as const;
export const TORRENT_PRIORITY_SHEET_ID = "torrent-priority" as const;
export const REMOVE_CONFIRM_SHEET_ID = "remove-confirm" as const;
export const LISTING_SHEET_ID = "listing" as const;
export const SELECT_SHEET_ID = "select" as const;
